...
public class Logement {
	...
	public boolean equals(Object o) {
		...
		return reference == logement.reference && Float.compare(prix, logement.prix) == 0
				&& Objects.equals(adresse, logement.adresse) && Objects.equals(delegation, logement.delegation)
				&& Objects.equals(gouvernorat, logement.gouvernorat) && type == logement.type
				&& Objects.equals(description, logement.description);
	}
